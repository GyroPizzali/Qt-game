...
#include "../../roguelikegame/gamepage.h"
...
QT_MOC_LITERAL(1, 9, 10), // "quitToMain"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "GamePage\0quitToMain\0"
};
...
void GamePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->quitToMain(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (GamePage::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GamePage::quitToMain)) {
                *result = 0;
                return;
            }
        }
